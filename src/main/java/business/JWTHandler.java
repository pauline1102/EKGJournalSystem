...
public class JWTHandler {
    ...
    public static String generateJwtToken(UserData user) {
...
//Generate a secret key, if there is none specified in the environment - only use fixed key in development for debugging
    ...
    // Validering af token
    public static UserData validate(String authentication) {
        ...
        try {
            ...
            UserData user = mapper.convertValue(claims.get("user"), UserData.class);
